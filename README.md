...
```
* Na diretório [app/webroot/files/](https://github.com/NeuroEasy/neuroeasy/tree/master/app/webroot/files) as permissões das pastas e tudo que estiver dentra dela precisam estar com a permissão liberada, com o código 0777
